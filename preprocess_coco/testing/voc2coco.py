...
def get_label2id(labels_path: str) -> Dict[str, int]:
    """id starts from 1; reads full lines as labels"""
...
'''
python voc2coco.py --ann_paths_list test_ann_paths.txt --labels labels.txt --output fintabnet_test.json --extract_num_from_imgid
'''